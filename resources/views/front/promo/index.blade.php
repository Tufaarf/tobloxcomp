...
<div class="container py-5 container--narrow">
  ...
  <h3 class="mb-4 text-center text-pink">Top Up Robux Promo</h3>
    ...
    <div class="row g-4">
      <div class="col-lg-7">
        ...
        <div class="card card-step p-4 mb-3">
          ...
          <input type="range" min="{{ $minRobux }}" max="{{ $maxRobux }}" step="50"
                 value="{{ old('robux_amount', $minRobux) }}"
  ...
  <span id="robuxAmount" class="pill" style="display:none">{{ old('robux_amount', $minRobux) }}</span>
</p>
