...
@section('content')
  ...
  <style>
    ...
    .btn-pink {
      ...
      border-radius: 12px;
      font-weight: 800;
      box-shadow: 0 10px 20px rgba(241, 135, 171, .35);
    }
  ...
  <div class="container container--narrow py-4">
    ...
    <div class="d-flex justify-content-center gap-2 mb-4">
      <a href="{{ route('order.track') }}" class="btn btn-pink" style="border-radius:99px; padding:10px 24px;">Cek
        Robux</a>
      <a href="{{ route('account.track') }}" class="btn btn-outline-secondary"
        style="border-radius:99px; padding:10px 24px; border-color:var(--border); background:#fff;">Cek Akun</a>
    </div>
    ...
    <div class="card p-4 mb-4">
      <form method="GET" action="{{ route('order.track') }}">
        ...
        <div class="d-flex gap-2">
          <input type="text" id="order_id" name="order_id" value="{{ $query }}" class="form-control"
            placeholder="Contoh: RBX-241231-ABCDE" required>
