...
@section('content')
  <style>
    ...
    .robux-section {
      background: #fff5f8;
      /* Light pink background from screenshot */
      padding: 50px 0;
    }
        ...
        <div class="container">
          <div class="robux-container">
            ...
            <div class="robux-card" data-aos="fade-up" data-aos-delay="200">
              <h3>Robux Via Login</h3>
              <p>
                Top up robux via login, proses cepat dan aman. Ideal untuk
                Kamu yang sedang terburu-buru tanpa mempertimbangkan harga.
              </p>
              <div class="robux-card-footer">
                <a href="https://instagram.com/toblox.id" class="btn-beli">Beli Sekarang</a>
              </div>
            </div>
